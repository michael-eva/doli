...
var require_locks = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/lib/locks.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_main5 = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/index.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.lockInternals = exports2.NavigatorLockAcquireTimeoutError = exports2.navigatorLock = exports2.GoTrueClient = exports2.GoTrueAdminApi = void 0;
    var GoTrueAdminApi_1 = __importDefault(require_GoTrueAdminApi());
  ...
  "node_modules/@supabase/supabase-js/dist/main/SupabaseClient.js"(exports2) {
    ...
    var SupabaseClient = class {
      ...
      constructor(supabaseUrl2, supabaseKey2, options) {
        ...
        this.fetch = (0, fetch_1.fetchWithAuth)(supabaseKey2, this._getAccessToken.bind(this), (_g = settings.global) === null || _g === void 0 ? void 0 : _g.fetch);
...
// netlify-functions/getMembers.ts
var import_supabase_js = __toESM(require_main6(), 1);
var supabaseUrl = "https://awkmxabdskcgxkzpqiru.supabase.co";
var supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF3a214YWJkc2tjZ3hrenBxaXJ1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDcxMTA0NjgsImV4cCI6MjAyMjY4NjQ2OH0.Fdtj34QT4KSrdZmfH2FE49Y1jBx4rTKFwrDN1ddSFjM";
...
exports.handler = async (event, context) => {
  const { error, data } = await supabase.from("members").select("*");
