...
import { handleUpdateDetailsSubmit } from "./utils/handleUpdateDetailsSubmit"
...
export default function SignUp() {
    ...
    function getSubmitFunction(data: SignUpType) {
        if (user) {
            return handleUpdateDetailsSubmit(data, primaryLocation, secondaryLocation, user, setIsSubmitting, navigate)
        } else {
