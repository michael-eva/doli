            ...
            <main className="flex flex-1 flex-col p-4 md:p-10">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <Card>
                        ...
                        <CardContent className="flex items-center justify-center py-8">
                            <div className="text-4xl font-bold">{claimedPosts} / {posts}</div>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="flex items-center gap-4">
                            <FileEditIcon className="w-8 h-8" />
                            <CardTitle className="text-2xl font-bold">Non-validated Users</CardTitle>
                            <Link className="ml-auto underline text-blue-500 dark:text-blue-400" to="unclaimed-posts">
                                View
                            </Link>
                        </CardHeader>
                        <CardContent className="flex items-center justify-center py-8">
                            <div className="text-4xl font-bold">{unverifiedMembers}</div>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="flex items-center gap-4">
                        ...
                        <CardContent className="flex items-center justify-center py-8">
                            <BarChart className="h-[200px] w-full" data={monthlyMember} />
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="flex items-center gap-4">
                        ...
                        <CardContent className="flex items-center justify-center py-8">
                            <BarChart className="h-[200px] w-full" data={monthlyListings} />
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="flex items-center gap-4">
                        ...
                        <CardContent className="flex items-center justify-center py-8">
                            <BarChart className="h-[200px] w-full" data={monthlyRating} />
                        </CardContent>
                    </Card>
                </div>
            </main>
